...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/emd-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14813&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/emd-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `emd` can be installed with:

```
conda install emd
```

It is possible to list all of the versions of `emd` available on your platform with:
